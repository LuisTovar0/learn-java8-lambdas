...
/*
        ...
        // o método é reduzido por o compilador do Java 8 ser melhor
...
*/
        ...
        // implementação inline da interface
        Greeter greeter1 = new Greeter() {
            // anonymous inner class
            @Override
            public void perform() {
                System.out.println("Implementação inline da interface Greeter!");
            }
        };
        greet(greeter1);
    ...
    public static void greet(Greeter greeter) {
         ...
         * conhecidos o tipo de retorno e quais os parâmetros necessários. Isto permite manter a segurança que o Java
         * tem sempre.
         */
        greeter.perform();
    }
